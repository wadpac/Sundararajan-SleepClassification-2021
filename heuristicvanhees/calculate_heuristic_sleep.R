...
library(data.table)
fname = "C:/Research/actigraphy/data/amc_new/features/features_30.0s.csv"
outputfile = "C:/Research/actigraphy/data/amc_new/features/features_30.0s_heuristic.csv"

# parameters for sleep detection algorithm
timethreshold = 5 # in minutes
anglethreshold = 5 # in degrees
epochsize = 30 # in seconds
